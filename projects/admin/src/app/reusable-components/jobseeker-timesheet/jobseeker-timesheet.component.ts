...
export class JobseekerTimesheetComponent implements OnInit {
	...
	getSumOfNormalWorkHrs() {
		...
		// 	return previous + current;
		// }, 0);
		// let TotalHrs = moment.duration(totalMin, 'minutes').format('hh:mm');
		// // console.log(Math.floor(totalMin / 60) + ':' + totalMin % 60);

		// let TotalHrsInDecimal = moment.duration(TotalHrs).asHours();
		// console.log(moment.duration(TotalHrs).asHours());
