...
export class JsonToCsvService {
	...
	csvInit(DataJSON: any, filename: string, options?: any) {
		let config = options || {};
	...
	formartData(data: any) {
		...
		if (this._options.decimalseparator === 'locale' && JsonToCsvService.isFloat(data)) {
			return data.toLocaleString();
		}

		if (this._options.decimalseparator !== '.' && JsonToCsvService.isFloat(data)) {
