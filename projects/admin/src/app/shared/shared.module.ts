...
import { EqualValidator, CompareDirective, AutocompleteDirective, FocusFirstInvalidFieldDirective } from '../directives/custom-directive.directive';
...
@NgModule({
	...
	declarations: [
		...
		TimesheetListDetailsComponent, AutocompleteDirective, FocusFirstInvalidFieldDirective
	],
	entryComponents: [
		TopProfiledialogComponent,
		TopShortcutdialogComponent,
	...
	exports: [
		...
		AccordionAnchorDirective,
		AccordionLinkDirective,
		AccordionDirective, AutocompleteDirective, FocusFirstInvalidFieldDirective
	],
	providers: [
		ConfigService,
		ApiCallService,
