...
const MENUITEMS = [
	...
	{
		state: '/employer/jobs/list',
		name: 'Jobs List',
		type: 'link',
		icon: 'work',
	},
	{
		state: '/employer/jobs/candidates/pendingapplication',
		name: 'Pending Job Applicants',
		type: 'link',
		icon: 'person',
	},
	{
		state: '/employer/jobs/add',
		name: 'Add Job',
		type: 'link',
		icon: 'settings',
	},
	{
		state: '/employer/settings/listusers',
		name: 'Users List',
		type: 'link',
		icon: 'settings',
	},
	{
		state: '/employer/settings/adduser',
		name: 'Add User',
		type: 'link',
		icon: 'settings',
	},
